...
class iCaRL(BaseLearner):
    ...
    def after_task(self):
        ...
        if self.save_task_checkpoints and self._cur_task in self.save_task_checkpoints:
            self.save_checkpoint(f'checkpoints/{self.args["convnet_type"]}_{self.args["dataset"]}_{self.args["init_cls"]}-{self.args["increment"]}_{self.args["model_name"]}_{self.args["memory_size"]}')
